...
By using this estimation, when inserting 64 billion files into 64 servers,
the whole system can still maintain at the speed of about 1000 operations per second per server. 
