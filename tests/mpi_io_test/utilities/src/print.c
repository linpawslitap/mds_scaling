...
*******************************************************************/
    snprintf( fancy_description, 1024, "MPI File %s Wait", op );
    collect_and_print_single_time( my_rank,
                                   num_procs,
                                   total_mbs,
...
*******************************************************************/
    collect_and_print_single_time( my_rank,
                                   ...
                                   "MPI File Preallocate Time",
                                   NULL,                        // no BW
                                   "MPI File Preallocate Time", // print time
                                   params->verbose_flag,
                                   ofptr,
                                   efptr );
...
*******************************************************************/
    collect_and_print_single_time( my_rank,
                                   ...
                                   "MPI File Close Wait",
                                   NULL,                  // no BW
                                   "MPI File Close Wait", // print time
                                   params->verbose_flag,
                                   ofptr,
                                   efptr );
...
*******************************************************************/
    if(params->aggregate_flag){
        collect_and_print_single_time( my_rank,
                                       ...
                                       "MPI Processor Send Wait",
                                       NULL,                      // no BW
                                       "MPI Processor Send Wait", // print time
                                       params->verbose_flag,
                                       ofptr,
                                       efptr );
        collect_and_print_single_time( my_rank,
                                       ...
                                       "MPI Processor Receive Wait",
                                       NULL,                         // no BW
                                       "MPI Processor Receive Wait", // yes time
                                       params->verbose_flag,
                                       ofptr,
                                       efptr );
